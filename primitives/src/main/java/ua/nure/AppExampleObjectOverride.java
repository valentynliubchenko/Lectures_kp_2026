...
public class AppExampleObjectOverride {
    public static void main(String[] args) {
        ...
        ExampleObjectOverride obj1 = new ExampleObjectOverride(1,12);
        ExampleObjectOverride obj2 = new ExampleObjectOverride(2,12);
        ExampleObjectOverride obj3 = new ExampleObjectOverride(1,12);
