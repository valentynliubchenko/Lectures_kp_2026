...
public class TreeSetExample {
    public static void main(String[] args) {
        ...
        people.add(new Person("Іван", "Петров", 25));
        people.add(new Person("Марія", "Коваленко", 30));
        people.add(new Person("Марія", "AКоваленко", 30));
        people.add(new Person("Петро", "Іваненко", 20));
        ...
        numbers.addAll(Set.of(5, 10, 15, 20, 25, 30));
